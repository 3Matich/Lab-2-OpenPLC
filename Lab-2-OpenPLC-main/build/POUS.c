...
void PROGRAM0_init__(PROGRAM0 *data__, BOOL retain) {
  __INIT_VAR(data__->JOYSICK,512,retain)
  __INIT_VAR(data__->VALAV,700,retain)
  __INIT_VAR(data__->VALRET,300,retain)
  ...
  __INIT_VAR(data__->CLOCK,__time_to_timespec(1, 400, 1, 0, 0, 0),retain)
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_VAR(data__->,_TMP_AND45_OUT,,AND__BOOL__BOOL(
    ...
    (BOOL)__GET_VAR(data__->_TMP_GT17_OUT,)));
  __SET_VAR(data__->TON0.,IN,,__GET_VAR(data__->_TMP_AND45_OUT,));
  ...
  __SET_VAR(data__->TON1.,IN,,__GET_VAR(data__->_TMP_AND45_OUT,));
  ...
  __SET_VAR(data__->TON2.,IN,,__GET_VAR(data__->_TMP_AND45_OUT,));
  ...
  __SET_VAR(data__->TON3.,IN,,__GET_VAR(data__->_TMP_AND45_OUT,));
